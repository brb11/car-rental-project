...
$sql="update vihical set name=:vehiclename,model_year=:modelyear,price=:priceperday,speed=:speed,state=:state,litter=:litter,horse_power=:horse_power,cat_id=:brand,img1=:img1,img2=:img2,img3=:img3,img4=:img4,img5=:img5 where id=:id";
...
<option value=""> Select </option>
<option value="bought">1</option>
<option value="still">0</option>
</select>
</div>
</div>
...
<div class="form-group">
<div class="col-sm-4">
Image 1 <img src="img/vehicleimages/<?php echo htmlentities($result->img1);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage1.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->img2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changeimage2.php?imgid=<?php echo htmlentities($result->id)?>">Change Image 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->img3);?>" width="300" height="200" style="border:solid 1px #000">
...
<div class="form-group">
<div class="col-sm-4">
Image 4<img src="img/vehicleimages/<?php echo htmlentities($result->img4);?>" width="300" height="200" style="border:solid 1px #000">
...
<img src="img/vehicleimages/<?php echo htmlentities($result->img5);?>" width="300" height="200" style="border:solid 1px #000">
