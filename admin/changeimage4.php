...
$sql="update vihical set img4=:vimage where id=:id";
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT img4 from vihical where vihical.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="img/vehicleimages/<?php echo htmlentities($result->img4);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
