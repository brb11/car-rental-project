...
$sql="INSERT INTO vihical(name,model_year,price,speed,state,litter,horse_power,cat_id,img1,img2,img3,img4,img5)
				   VALUES(:vehiclename,:modelyear,:priceperday,:speed,:state,:litter,:horse_power,:brand,:img1,:img2,:img3,:img4,:img5)";
